...
description: GetUserAvailabilityResponse 要素は、ユーザーの可用性情報または推奨される会議時間情報を定義するプロパティを含むルート要素です。
ms.openlocfilehash: 16a6f79f6ccc930e3847867a560bc042657f12a3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59521909"
---
# <a name="getuseravailabilityresponse"></a>GetUserAvailabilityResponse

**GetUserAvailabilityResponse** 要素は、ユーザーの可用性情報または推奨される会議時間情報を定義するプロパティを含むルート要素です。 
...
|**Element**|**説明**|
|:-----|:-----|
|[FreeBusyResponseArray](freebusyresponsearray.md) <br/> |要求されたユーザーの可用性情報と応答の状態が含まれる。  <br/> |
|[SuggestionsResponse](suggestionsresponse.md) <br/> |要求された会議の提案に関する応答状態情報と提案データを格納します。  <br/> |
...
GetUserAvailability 応答の次の例は、GetUserAvailability 要求への応答を示しています。
...
[ID 要素の](id.md)内容は、読みやすさを維持するために短縮されました。 
