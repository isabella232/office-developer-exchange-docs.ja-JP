...
**Getdomainsettingsrequest**要素は、 [getdomainsettings operation (SOAP)](getdomainsettings-operation-soap.md)操作要求を表します。 
...
|[RequestedSettings (SOAP)](requestedsettings-soap.md) <br/> |要求されたドメイン構成設定の名前が含まれています。  <br/> |
