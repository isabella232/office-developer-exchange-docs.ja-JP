...
**SearchArchiveOnly**要素は、非インデックス付け可能なアイテムのアーカイブ メールボックスのみを検索するかどうかを示します。 
...
の**場合は true** 、 **SearchArchiveOnly**要素のテキスト値は、その非インデックス付け可能な項目のみが検索されますアーカイブ メールボックスのことを示します。 テキスト値が**false**のでは、プライマリ メールボックスとアーカイブ メールボックスに対して検索が実行されることを示します。 
