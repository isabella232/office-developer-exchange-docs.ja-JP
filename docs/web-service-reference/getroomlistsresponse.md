...
---
# <a name="getroomlistsresponse"></a>た getroomlistsresponse

**た getroomlistsresponse**要素は、 [GetRoomLists 操作](getroomlists-operation.md)要求からの応答を定義します。 
...
|[RoomLists](roomlists.md) <br/> |会議室のリストを表す電子メールアドレスと表示名のリストを提供します。  <br/> |
