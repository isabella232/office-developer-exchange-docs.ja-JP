...
**Description**要素は、リテンション ・ ポリシーの説明テキストを指定します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[RetentionPolicyTag](retentionpolicytag.md) <br/> |メールボックス アイテムの保持ポリシーを指定します。  <br/> |
   
## <a name="text-value"></a>テキスト値

**Description**要素のテキスト値は、リテンション ・ ポリシーを説明する文字列値です。 
