...
|**アクセス許可レベル**|**説明**|
|:-----|:-----|
|なし  <br/> |代理ユーザーには、連絡先フォルダーにアクセス許可がありません。  <br/> |
|Reviewer  <br/> |代理ユーザーは、連絡先フォルダー内のアイテムを読み取ることができます。  <br/> |
|作成者  <br/> |代理ユーザーは、読み取りし、連絡先フォルダーにアイテムを作成できます。  <br/> |
|Editor  <br/> |代理ユーザーは読み取り、作成、および連絡先フォルダー内のアイテムを変更します。  <br/> |
|カスタム  <br/> |代理ユーザーは、連絡先フォルダーにカスタム アクセス許可を持ちます。  <br/> |
