...
description: DeleteUserConfigurationResponseMessage 要素には、単一の DeleteUserConfiguration 要求の状態と結果が含まれる。
ms.openlocfilehash: fd334fc4c6b500f774c3ae9bda5390cce93d709b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59545385"
---
# <a name="deleteuserconfigurationresponsemessage"></a>DeleteUserConfigurationResponseMessage

**DeleteUserConfigurationResponseMessage** 要素には、単一の **DeleteUserConfiguration** 要求の状態と結果が含まれる。 
