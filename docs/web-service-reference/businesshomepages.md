...
description: BusinessHomePages 要素は、ビジネス ホーム ページの配列と、関連付けられたペルサのソース属性の識別子を指定します。
ms.openlocfilehash: b8382681bd0abebcff2ddaec67d56cbe568e07f0
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59543577"
---
# <a name="businesshomepages"></a>BusinessHomePages

**BusinessHomePages** 要素は、ビジネス ホーム ページの配列と、関連付けられたペルサのソース属性の識別子を指定します。 
