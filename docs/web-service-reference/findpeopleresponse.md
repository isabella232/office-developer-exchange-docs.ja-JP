...
|**要素**|**説明**|
|:-----|:-----|
|[連絡先](people.md) <br/> |**FindPeople**要求の結果として返されるペルソナ データの配列を指定します。  <br/> |
|[TotalNumberOfPeopleInView](totalnumberofpeopleinview.md) <br/> |**FindPeople**の要求によって返されるサーバーに格納されているペルソナの合計数を指定します。  <br/> |
