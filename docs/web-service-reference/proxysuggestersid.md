...
**ProxySuggesterSid**要素は、サーバーの役割がインストールされ、Exchange Web サービス操作によって使用されていないクライアントのアクセス権を持つ Microsoft Exchange Server 2007 を実行しているコンピューターの HTTP プロキシによって使用されます。 この要素は、Exchange Server 2007 Service Pack 1 (SP1) で導入されました。 
