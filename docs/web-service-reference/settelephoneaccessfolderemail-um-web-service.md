...
**SetTelephoneAccessFolderEmail**要素は、ユニファイド メッセージングはの読み取り元のメッセージに電話する既定の電子メール フォルダーに設定する要求を定義します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[base64FolderId (UM web サービス)](base64folderid-um-web-service.md) <br/> |[メール] フォルダーの識別子です。  <br/> |
