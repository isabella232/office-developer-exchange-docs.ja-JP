...
**CreateManagedFolderResponseMessage**要素には、状態および 1 つの結果が含まれています[CreateManagedFolder 操作](createmanagedfolder-operation.md)を要求します。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | [CreateManagedFolder 操作](createmanagedfolder-operation.md)の応答のステータスについて説明します。<br/><br/>次の値は、この属性の有効です。<br/><br/>-成功  <br/>-警告  <br/>-エラー  <br/> |
...
|[フォルダー](folders-ex15websvcsotherref.md) <br/> |作成された管理フォルダーの配列が含まれています。  <br/> |
