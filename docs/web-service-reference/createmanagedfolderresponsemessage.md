...
description: CreateManagedFolderResponseMessage 要素には、単一の CreateManagedFolder 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 5f98a056f34860161b69a250cf056e54d2b1f647
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59536309"
---
# <a name="createmanagedfolderresponsemessage"></a>CreateManagedFolderResponseMessage

**CreateManagedFolderResponseMessage** 要素には、単一の [CreateManagedFolder](createmanagedfolder-operation.md)操作要求の状態と結果が含まれる。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | [CreateManagedFolder 操作応答の状態を説明](createmanagedfolder-operation.md)します。<br/><br/>この属性には、次の値が有効です。<br/><br/>- 成功  <br/>- 警告  <br/>- エラー  <br/> |
...
|[フォルダー](folders-ex15websvcsotherref.md) <br/> |作成された管理フォルダーの配列を含む。  <br/> |
