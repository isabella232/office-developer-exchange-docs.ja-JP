...
**EcpUrl-extinstall**要素は、 [EcpUrl (POX)](ecpurl-pox.md)要素の値と組み合わせて、ユーザーのメールボックスに現在インストールされているメールアプリを表示または変更するために使用できる url を生成できる url の一部を指定します。 
...
テキスト値は、 [EcpUrl (POX)](ecpurl-pox.md)要素の値と組み合わせて、ユーザーのメールボックスに現在インストールされているメールアプリを表示または変更するために使用できる url を生成できる url の部分を表します。 
  
## <a name="remarks"></a>注釈

**EcpUrl-extinstall**要素は、 **Protocol**要素のオプションの子要素です。 
