...
description: DisplayCc 要素は、Cc ボックスのコンテンツに使用される表示文字列を表します。 これは、すべての Cc 受信者の表示名の連結文字列です。
ms.openlocfilehash: 9c0ec732256cd45b0c7aa1f12136620981af6944
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59513809"
---
# <a name="displaycc"></a>DisplayCc

**DisplayCc 要素** は、Cc ボックスのコンテンツに使用される表示文字列を表します。 これは、すべての Cc 受信者の表示名の連結文字列です。 
...
テキスト値は、[Cc] ボックスの内容に使用される表示文字列を表します。
