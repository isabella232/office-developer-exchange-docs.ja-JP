...
**IsMeetngRequest**要素は、受信メッセージに適用する条件または例外の順序での会議出席依頼をする必要があるかどうかを示します。 
...
**True**の場合、テキスト値は、メッセージが適用の条件または例外のために会議出席依頼をする必要があることを示します。 **False**の値は、メッセージが適用の条件または例外のために会議出席依頼をする必要がありますいないことを示します。 
