...
**ProtectionRulesConfiguration**要素には、保護ルールのサービスのサービスの構成情報が含まれています。 
...
|**属性**|**説明**|
|:-----|:-----|
|**間隔** <br/> |どのくらいの頻度、時間の単位でクライアントする必要があります保護規則サーバーからの要求を指定します。 この属性は必須であり、その値は 1 以上の整数である必要があります。  <br/> |
   
### <a name="child-elements"></a>子要素

|**要素**|**説明**|
|:-----|:-----|
|[ルール](rules-ex15websvcsotherref.md) <br/> |保護規則の配列。 この要素は必須です。  <br/> |
...
保護ルールのサービスの構成は、ルール、内部ドメイン、および更新間隔の一覧で構成されます。
