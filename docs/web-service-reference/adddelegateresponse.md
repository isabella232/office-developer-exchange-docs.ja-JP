...
description: AddDelegateResponse 要素には、AddDelegate 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 2e630d42b004f6c7ccaf7cc2240369dcf312068b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59544394"
---
# <a name="adddelegateresponse"></a>AddDelegateResponse

**AddDelegateResponse** 要素には [、AddDelegate](adddelegate-operation.md)操作要求の状態と結果が含まれる。 
