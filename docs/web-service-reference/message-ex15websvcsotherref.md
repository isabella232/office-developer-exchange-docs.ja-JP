...
description: Message 要素は、Microsoft の電子メール Exchangeを表します。
ms.openlocfilehash: 408e3e0f483d73e5559877fdf7eca33ed0969683
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542156"
---
# <a name="message"></a>メッセージ

**Message 要素** は、Microsoft Exchange電子メール メッセージを表します。 
...
|[ReceivedBy](receivedby.md) <br/> |代理人アクセス シナリオの代理人を識別します。  <br/> |
|[ReceivedRepresenting](receivedrepresenting.md) <br/> |代理人アクセス シナリオのプリンシパルを識別します。  <br/> |
...
|[ReminderMessageData](remindermessagedata.md) <br/> |アラーム メッセージのデータを格納します。  <br/> |
...
別 **の Message** 要素 [である Message (Availability)](message-availability.md) は、OOF メッセージを返す可用性操作によって使用されます。 
  
[メッセージ](message-ex15websvcsotherref.md)要素は、電子メール メッセージと、Web サービス (EWS) スキーマによって強く入力されていない他のすべてのExchangeを表します。 IPM などのアイテム。共有と IPM.InfoPath は Message 要素として **返** されます。 Exchange 2010 では、応答の基本 **Item** 要素は返されない。 
