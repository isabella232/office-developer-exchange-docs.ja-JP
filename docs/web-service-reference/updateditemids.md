...
**UpdatedItemIds**要素は、更新されたアイテムの識別子を指定します。 
...
[PerformReminderAction](performreminderaction-operation.md)操作が正常に完了しませんでした、またはサーバー上で変更されていない、 **UpdatedItemIds**の要素が空の値として返されます。 
