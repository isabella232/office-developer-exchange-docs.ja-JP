...
description: UnsubscribeResponseMessage 要素には、1 つの Unsubscribe 操作要求の状態と結果が含まれる。
...
**UnsubscribeResponseMessage** 要素には、1 つの Unsubscribe 操作要求の状態と結果 [が含](unsubscribe-operation.md)まれる。 
