...
**StartTimeZoneId 要素のテキスト** 値は [、Start](start.md)要素で使用されるタイム ゾーンのタイム ゾーン識別子です。 
