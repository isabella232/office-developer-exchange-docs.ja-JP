...
description: RefreshSharingFolderResponseMessage 要素には、単一の RefreshSharingFolder 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 69a490027d98f1b2a320449c89fddd6f4f53c838
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542861"
---
# <a name="refreshsharingfolderresponsemessage"></a>RefreshSharingFolderResponseMessage

**RefreshSharingFolderResponseMessage** 要素には、[単一の RefreshSharingFolder](refreshsharingfolder-operation.md)操作要求の状態と結果が含まれる。 
