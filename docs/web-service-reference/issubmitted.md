...
description: IsSubmitted 要素は、アイテムが Outbox の既定のフォルダーに送信されたかどうかを示します。
ms.openlocfilehash: 4914064db10bb2cf9e865a3b1ca8cc65c41f6400
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59514467"
---
# <a name="issubmitted"></a>IsSubmitted

**IsSubmitted** 要素は、アイテムが Outbox の既定のフォルダーに送信されたかどうかを示します。 
...
テキスト値が **true の場合** は、アイテムが送信ボックス フォルダーに送信されたかどうかを示します。 
