...
|[Body](body.md) <br/> |**CancelCalendarItem で使用されません**。 [NewBodyContent プロパティを使用](newbodycontent.md)して、本文の内容を設定します。  <br/> |
...
**CancelCalendarItem** 要素は、オーガナイザーによってのみ表示されます。 これは、開催者の予定表アイテムにのみ適用されます。 
