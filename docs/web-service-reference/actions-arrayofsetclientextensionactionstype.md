...
---
# <a name="actions-arrayofsetclientextensionactionstype"></a>アクション (ArrayOfSetClientExtensionActionsType)

**アクション**要素は、クライアントの拡張機能で実行するアクションの配列を指定します。 
...
[アクション (SetClientExtensionActionType)](action-setclientextensionactiontype.md)
