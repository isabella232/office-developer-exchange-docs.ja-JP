...
**ResponseMessages**要素には、サービス構成の応答メッセージの配列が含まれています。 
...
|**要素**|**説明**|
|:-----|:-----|
|[ServiceConfigurationResponseMessageType](serviceconfigurationresponsemessagetype.md) <br/> |サービス構成の設定が含まれています。 この要素は必須です。  <br/> |
