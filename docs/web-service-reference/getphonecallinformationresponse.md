...
description: GetPhoneCallInformationResponse 要素は、1 つの GetPhoneCallInformation 要求に対する応答を定義します。
ms.openlocfilehash: a23c8516765cf3b273448745bb31a653222143a2
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539930"
---
# <a name="getphonecallinformationresponse"></a>GetPhoneCallInformationResponse

**GetPhoneCallInformationResponse** 要素は、1 つの GetPhoneCallInformation 要求に対する応答を定義します。 
