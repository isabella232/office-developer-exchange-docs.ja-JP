...
**SearchFolder**の要素は、メールボックスに格納されている検索フォルダーを表します。 
...
|[SearchParameters](searchparameters.md) <br/> |検索フォルダーを定義するパラメーターが含まれています。  <br/> |
 ...
 **SearchFolder**を使用して通常の検索フォルダーと MicrosoftOfficeOutlook と Outlook Web Access の表示の両方のフォルダーを検索します。 Outlook と Outlook Web Access に表示する検索フォルダーを使用して識別されたフォルダーの下にあるフォルダーを作成しなければなりません。 
