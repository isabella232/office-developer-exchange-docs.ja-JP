...
**Applicationuri**要素は、アプリケーションの場所を定義します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[Response (GetFederationInformation) (SOAP)](response-getfederationinformationsoap.md) <br/> |GetFederation response 情報を格納します。  <br/> |
