...
ms.locfileid: "59520109"
---
# <a name="applicationuri-soap"></a>ApplicationUri (SOAP)

**ApplicationUri 要素** は、アプリケーションの場所を定義します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[Response (GetFederationInformation) (SOAP)](response-getfederationinformationsoap.md) <br/> |GetFederation 応答情報が含まれる。  <br/> |
   
## <a name="text-value"></a>テキスト値

テキスト値は、アプリケーションの URI を表します。
