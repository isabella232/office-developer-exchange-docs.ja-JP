...
description: GetServerTimeZonesResponseMessage 要素には、1 つの GetServerTimeZones 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 64f4669b4c6cd8c7e29cfa11c8b389be7f72fcd4
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59509799"
---
# <a name="getservertimezonesresponsemessage"></a>GetServerTimeZonesResponseMessage

**GetServerTimeZonesResponseMessage** 要素には、1 つの [GetServerTimeZones](getservertimezones-operation.md)操作要求の状態と結果が含まれる。 
...
|[TimeZoneDefinitions](timezonedefinitions.md) <br/> |タイム ゾーン定義の配列を含む。  <br/> |
