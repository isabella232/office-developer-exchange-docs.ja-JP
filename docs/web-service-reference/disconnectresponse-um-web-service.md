...
---
# <a name="disconnectresponse-um-web-service"></a>[切断] 応答 (UM web サービス)

Disconnect **response**要素は、[切断操作 (UM web サービス)](disconnect-operation-um-web-service.md)要求への応答を定義します。 
