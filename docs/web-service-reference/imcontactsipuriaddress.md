...
---
# <a name="imcontactsipuriaddress"></a>Imcontactsi紫 Iaddress

**Imcontactsi紫 Iaddress**要素には、インスタントメッセージング (IM) グループに追加される連絡先の SIP URI アドレスが含まれます。 
...
**Imcontactsi紫 Iaddress**要素のテキスト値は、連絡先の SIP URI アドレスです。 
