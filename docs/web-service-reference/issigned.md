...
**IsSigned**要素を適用する場合の条件または例外の順序で受信したメッセージに署名が必要かどうかを示します。 
...
**True**の場合、テキスト値を適用する場合の条件または例外の順序でメッセージを署名する必要があることを示します。 **False**のテキスト値は、メッセージに適用する条件または例外の署名がないことを示します。 
