...
**Location**要素では、予定表アイテムの [場所] フィールドを表します。 
...
テキスト値は、この要素が応答で返された場合に必要です。 この要素は、空の文字列を含めることができます。 [CalendarEventDetails](calendareventdetails.md)要素を使用する場合、この要素はオプションです。 
  
## <a name="remarks"></a>備考

この要素は、PR_Location の MAPI 名前付きプロパティにマップします。
