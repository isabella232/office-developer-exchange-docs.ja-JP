...
description: YearlyRegeneration 要素は、タスクが再生成される頻度を年数で表します。
...
**YearlyRegeneration 要素は**、タスクが再生成される頻度を年数で表します。 
...
|**Element**|**説明**|
|:-----|:-----|
|[間隔](interval.md) <br/> |タスクの完了後に新しいタスクが再生成される間隔を年数で定義します。  <br/> |
