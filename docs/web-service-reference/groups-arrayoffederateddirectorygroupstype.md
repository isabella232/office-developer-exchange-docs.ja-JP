...
---
# <a name="groups-arrayoffederateddirectorygroupstype"></a>グループ (ArrayOfFederatedDirectoryGroupsType)

**グループ (ArrayOfFederatedDirectoryGroupsType)** の要素は内部使用のみを目的としています。 
