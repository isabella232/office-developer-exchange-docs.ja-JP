...
**GreetingType**要素は、 [PlayOnPhoneGreeting 操作 (UM web サービス)](playonphonegreeting-operation-um-web-service.md)の要求で使用するあいさつ文の種類を定義します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[PlayOnPhoneGreeting (UM web サービス)](playonphonegreeting-um-web-service.md) <br/> |ユニファイド メッセージング、電話の案内応答を再生する要求を定義します。  <br/> |
