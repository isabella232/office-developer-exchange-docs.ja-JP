...
**RelativeFolderPath**要素には、フォルダーへのパスを作成するフォルダーの相対パスを指定するフォルダーの配列が含まれています。 
...
[フォルダー](folder.md) | [CalendarFolder](calendarfolder.md) | [メッセージ](contactsfolder.md) | [SearchFolder](searchfolder.md) | [TasksFolder](tasksfolder.md)
