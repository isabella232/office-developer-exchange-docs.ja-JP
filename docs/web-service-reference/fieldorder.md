...
**Fieldorder**要素は、結果を並べ替えるための1つのフィールドを表し、並べ替えの方向を示します。 
...
|**属性**|**説明**|
|:-----|:-----|
|**Order** <br/> | 並べ替え順序の方向を表します。<br/><br/> 指定可能な値は次のいずれかです。 <br/> <br/>-昇順  <br/>-降順  <br/> |
...
|**要素**|**説明**|
|:-----|:-----|
|[SortOrder](sortorder.md) <br/> |FindItem 要求でのアイテムの並べ替え方法を定義します。  <br/> この要素の XPath 式を次に示します。`/FindItem/SortOrder` <br/> |
