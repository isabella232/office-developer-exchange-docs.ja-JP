...
**DeleteItems**要素では、フォルダー内のどのアイテムを削除する権限をユーザーが持っていることを示します。 この要素は、Microsoft Exchange Server 2007 Service Pack 1 (SP1) で導入されました。 
...
次の表は、 **DeleteItems**要素の値を一覧します。 
  
**DeleteItems 要素のテキスト値**

|**値**|**説明**|
|:-----|:-----|
|なし  <br/> |ユーザーに、フォルダー内のアイテムを削除する権限がないことを示します。  <br/> |
|Owned (所有)  <br/> |ユーザーがフォルダーにユーザーが所有しているアイテムを削除する権限を持っていることを示します。  <br/> |
|All  <br/> |ユーザーがフォルダー内のすべてのアイテムを削除する権限を持っていることを示します。  <br/> |
