...
description: CreateFolderResponseMessage 要素には、1 つの CreateFolder 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 846010bdd3f4543fd16eba08b6598d7168c37ee4
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59544270"
---
# <a name="createfolderresponsemessage"></a>CreateFolderResponseMessage

**CreateFolderResponseMessage** 要素には、1 つの CreateFolder 操作要求の状態と [結果が含](createfolder-operation.md)まれる。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | CreateFolder 操作応答 [の状態を説明](createfolder-operation.md) します。<br/><br/>この属性には、次の値が有効です。<br/><br/>- 成功  <br/>- 警告  <br/>- エラー  <br/> |
...
|[フォルダー](folders-ex15websvcsotherref.md) <br/> |作成されたフォルダーの配列を含む。  <br/> |
