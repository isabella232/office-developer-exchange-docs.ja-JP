...
**CreateFolderResponseMessage**要素には、1つの[CreateFolder 操作](createfolder-operation.md)要求の状態と結果が含まれています。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | [CreateFolder 操作](createfolder-operation.md)の応答の状態を表します。<br/><br/>この属性には、次の値が有効です。<br/><br/>-成功  <br/>-Warning  <br/>-エラー  <br/> |
...
|[フォルダー](folders-ex15websvcsotherref.md) <br/> |作成されたフォルダーの配列を格納します。  <br/> |
