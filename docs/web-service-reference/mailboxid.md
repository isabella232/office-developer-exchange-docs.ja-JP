...
**MailboxId**要素は、探索検索によってアクセスされるメールボックスの識別子を指定します。 
...
[MailboxStat](mailboxstat.md) | [(PreviewItemMailboxType) のメールボックス](mailbox-previewitemmailboxtype.md)
  
## <a name="text-value"></a>テキスト値

**MailboxId**要素のテキスト値は、検索のアクセスされているメールボックスのメールボックス識別子です。 
