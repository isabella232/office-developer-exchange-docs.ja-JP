...
description: DisconnectPhoneCallResponse 要素には、単一の DisconnectPhoneCall 要求の状態と結果が含まれる。
ms.openlocfilehash: a8a5c7e238baeee79542cad41af184632b66d4e2
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59535565"
---
# <a name="disconnectphonecallresponse"></a>DisconnectPhoneCallResponse

**DisconnectPhoneCallResponse** 要素には、単一の **DisconnectPhoneCall** 要求の状態と結果が含まれる。 
