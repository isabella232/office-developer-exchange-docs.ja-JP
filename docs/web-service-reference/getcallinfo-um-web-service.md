...
---
# <a name="getcallinfo-um-web-service"></a>GetCallInfo (UM web サービス)

**GetCallInfo**要素は、呼び出しに関する情報を取得する要求を定義します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[CallId (UM web サービス)](callid-um-web-service.md) <br/> |に関する情報を取得する呼び出しの id が含まれています。  <br/> |
