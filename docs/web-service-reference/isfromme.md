...
description: IsFromMe 要素は、ユーザーがアイテムを自分に送信したかどうかを示します。
...
**IsFromMe** 要素は、ユーザーがアイテムを自分に送信したかどうかを示します。 
...
テキスト値が **true の場合** は、アイテムがユーザーによって自分に送信されたかどうかを示します。 false の **値は** 、アイテムがユーザーによって自分に送信されていない状態を示します。 
