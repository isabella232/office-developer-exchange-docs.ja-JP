...
**TelephoneAccessNumbers**要素には、ユニファイド メッセージング[(UM web サービス) の GetUMProperties 操作](getumproperties-operation-um-web-service.md)の要求への応答で返されるようにアクセスするユーザーが使用できる電話番号の一覧を示す値が含まれています。 
