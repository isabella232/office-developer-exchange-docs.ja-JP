...
description: DelegateUserResponseMessageType 要素には、1 人の代理人ユーザーに対する応答メッセージが含まれる。
ms.openlocfilehash: 7318c80d72022384ca4f0352ec85f68aeede8e22
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59545469"
---
# <a name="delegateuserresponsemessagetype"></a>DelegateUserResponseMessageType

**DelegateUserResponseMessageType** 要素には、1 人の代理人ユーザーに対する応答メッセージが含まれる。 
...
|[DelegateUser](delegateuser.md) <br/> |代理人管理応答で返される 1 つのデリゲートを識別します。  <br/> |
