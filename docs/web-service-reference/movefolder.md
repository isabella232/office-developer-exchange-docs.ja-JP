...
**MoveFolder**要素は、Exchange ストア内のフォルダーを移動する要求を定義します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[ToFolderId](tofolderid.md) <br/> |移動したフォルダーのコピー先フォルダーを表します。  <br/> |
|[FolderIds](folderids.md) <br/> |[ToFolderId](tofolderid.md)要素で指定されたフォルダーに移動するフォルダーの配列が含まれています。  <br/> |
