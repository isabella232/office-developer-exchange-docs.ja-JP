...
この要素を使用する場合は、テキスト値が必要です。 この要素で使用できる値は次のとおりです。
  
- **Single** アイテムは定期的な予定表アイテムに関連付けではありません。 
    
- **オカレンス** アイテムは定期的な予定表アイテムの出現です。 
    
- **例外** アイテムは定期的な予定表アイテムの例外です。 
