...
description: UniqueBody 要素は、この会話の一意の本文を表す HTML フラグメントまたはプレーン テキストを表します。
ms.openlocfilehash: 419247aaa952f1d15633fe431912f87ad4d6db85
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59538674"
---
# <a name="uniquebody"></a>UniqueBody

**UniqueBody 要素は**、この会話の一意の本文を表す HTML フラグメントまたはプレーン テキストを表します。 
...
|**属性**|**説明**|
|:-----|:-----|
|**BodyType** <br/> |アイテムの本文をアイテムに格納する方法について説明します。  <br/> |
