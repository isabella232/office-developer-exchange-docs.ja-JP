...
**CreateRuleOperation**要素は、新しい受信トレイ ルールを作成する操作を表します。 
...
|**要素**|**説明**|
|:-----|:-----|
|[ルール (RuleType)](rule-ruletype.md) <br/> |ユーザーのメールボックス内に作成する規則を表します。  <br/> |
   
### <a name="parent-elements"></a>親要素

|**要素**|**説明**|
|:-----|:-----|
|[Operations](operations.md) <br/> |受信トレイで実行できる操作が含まれています。  <br/> |
