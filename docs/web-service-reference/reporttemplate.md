...
**ReportTemplate**要素を取得するレポートの種類を表します。 
...
**ReportTemplate**要素の有効な値を次の表に一覧します。 
  
**ReportTemplate 要素の値**

|**値**|**説明**|
|:-----|:-----|
|概要  <br/> |レポートを表示するメッセージのすべての受信者、メッセージの配信状態の各受信者を指定します。  <br/> |
|RecipientPath  <br/> |1 人の受信者を指定するレポートでは発生したイベントの完全な履歴が表示されます。  <br/> |
