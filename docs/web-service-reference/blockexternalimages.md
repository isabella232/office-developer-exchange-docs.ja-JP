...
**Blockexternalimages**要素は、HTML テキスト本文で外部画像がブロックされるかどうかを指定します。 
...
|[ItemShape](itemshape.md) <br/> |GetItem、FindItem、または SyncFolderItems 応答に含めるアイテムのプロパティとコンテンツを指定します。  <br/> |
   
## <a name="text-value"></a>テキスト値

**Blockexternalimages**要素のテキスト値が**true の場合**は、HTML 本文で外部画像がブロックされていることを示します。 値が**false**の場合は、外部画像が許可されていることを示します。 
