...
---
# <a name="persona"></a><span data-ttu-id="d216f-103">ペルソナ</span><span class="sxs-lookup"><span data-stu-id="d216f-103">Persona</span></span>

<span data-ttu-id="d216f-104">**ペルソナ**の要素は、 **GetPersona**の要求によって返されるペルソナ データのセットを指定します。</span><span class="sxs-lookup"><span data-stu-id="d216f-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
