...
---
# <a name="persona"></a><span data-ttu-id="a5e33-103">ペルソナ</span><span class="sxs-lookup"><span data-stu-id="a5e33-103">Persona</span></span>

<span data-ttu-id="a5e33-104">**Persona**要素は、 **getpersona**要求によって返される一連のペルソナデータを指定します。</span><span class="sxs-lookup"><span data-stu-id="a5e33-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
