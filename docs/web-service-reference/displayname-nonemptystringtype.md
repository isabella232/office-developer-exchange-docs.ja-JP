...
---
# <a name="displayname-nonemptystringtype"></a>表示名 (NonEmptyStringType)

**表示名**要素には、インスタント メッセージングの連絡先のグループまたは新しいインスタント メッセージング グループの表示名の表示名が含まれています。 
...
**DisplayName**要素のテキスト値は、インスタント メッセージングの連絡先のグループまたは新しいインスタント メッセージング グループの表示名の表示名です。 
