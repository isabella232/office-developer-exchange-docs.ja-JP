...
**PostOfficeBox**要素は、郵便の宛先の「私書箱」部分を指定します。 
...
[住所 (PersonaPostalAddressType)](postaladdress-personapostaladdresstype.md) | [(PersonaPostalAddressType) の値](value-personapostaladdresstype.md)
  
## <a name="text-value"></a>テキスト値

**PostOfficeBox**要素のテキスト値は、私書箱の識別子です。 
