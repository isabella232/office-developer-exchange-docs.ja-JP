...
**UpdateItemResponseMessage**要素には、1つの[updateitem 操作](updateitem-operation.md)要求の状態と結果が含まれています。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | [Updateitem 操作](updateitem-operation.md)の応答の状態を表します。 <br/><br/>この属性には、次の値が有効です。  <br/><br/>-成功  <br/>-Warning  <br/>-エラー  <br/> |
...
|[Items](items.md) <br/> |更新されたアイテムの配列を格納します。  <br/> |
