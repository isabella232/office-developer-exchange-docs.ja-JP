...
description: ToRecipients 要素には、アイテムの受信者の配列が含まれる。 これらはアイテムの主要な受信者です。
ms.openlocfilehash: 1e49a3113328b0573124948056f684de72f27b3f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59527252"
---
# <a name="torecipients"></a>ToRecipients

**ToRecipients 要素** には、アイテムの受信者の配列が含まれる。 これらはアイテムの主要な受信者です。 
...
FindItem 要求 **を使用して ToRecipients** を取得することはできません。 GetItem 要求を使用して **ToRecipients を取得します**。
