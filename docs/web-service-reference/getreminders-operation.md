...
<span data-ttu-id="1a595-158">応答 SOAP 本文には、次の要素が含まれています。</span><span class="sxs-lookup"><span data-stu-id="1a595-158">The response SOAP body contains the following elements:</span></span>
