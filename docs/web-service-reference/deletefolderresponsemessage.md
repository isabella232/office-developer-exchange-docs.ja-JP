...
description: DeleteFolderResponseMessage 要素には、単一の DeleteFolder 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 9002764f55981d7bb24a18c41312393b24a075d1
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542457"
---
# <a name="deletefolderresponsemessage"></a>DeleteFolderResponseMessage

**DeleteFolderResponseMessage** 要素には、単一の [DeleteFolder](deletefolder-operation.md)操作要求の状態と結果が含まれる。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | DeleteFolder 操作応答 [の状態を説明](deletefolder-operation.md) します。<br/><br/>この属性には、次の値が有効です。<br/><br/>- 成功  <br/>- 警告  <br/>- エラー  <br/> |
