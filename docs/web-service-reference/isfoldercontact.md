...
**Isfoldercontact**要素は、ユーザーがフォルダーの連絡先であるかどうかを示します。 この要素は、Microsoft Exchange Server 2007 Service Pack 1 (SP1) で導入されました。 
...
テキスト値が**true の場合**は、ユーザーが指定されたフォルダーの連絡先であることを示します。 値が**false**の場合は、ユーザーが指定されたフォルダーの連絡先ではないことを示します。 
