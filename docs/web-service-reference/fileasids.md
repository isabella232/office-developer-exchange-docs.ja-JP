...
description: FileAsIds 要素は、StringAttributedValue 要素の配列と、関連付けられたペルサのソース属性の識別子を指定します。
ms.openlocfilehash: c73890edd19f9b00511ed2d10b21e3b10516d87f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59546519"
---
# <a name="fileasids"></a>FileAsIds

**FileAsIds** 要素は **、StringAttributedValue** 要素の配列と、関連付けられたペルサのソース属性の識別子を指定します。 
