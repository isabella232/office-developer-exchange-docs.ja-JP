...
**Editallowed**要素は、Information Rights Management を編集できるかどうかを指定します。 
...
**Editallowed**要素のテキスト値が**true の場合**、INFORMATION Rights Management (IRM) が編集可能であることを示します。 値が**false**の場合は、IRM を編集できないことを示します。 
