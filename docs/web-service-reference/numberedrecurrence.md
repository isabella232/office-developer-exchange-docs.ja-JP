...
description: NumberedRecurrence 要素は、定期的なアイテムの開始日と出現回数を表します。
...
**NumberedRecurrence 要素** は、定期的なアイテムの開始日と出現回数を表します。 
...
|[NumberOfOccurrences](numberofoccurrences.md) <br/> |定期的なアイテムの出現回数を格納します。  <br/> |
