...
**UMUrl**要素は、最適なメールが有効なユーザーのユニファイド メッセージングの Web サービスのインスタンスの URL を指定します。 
...
テキスト値は、ユニファイド メッセージング サーバーの役割が Exchange トポロジの場合、インストールされている Exchange サーバーの URL を指定します。
