...
description: IsNotEqualTo 要素は、プロパティと定数値または別のプロパティを比較する検索式を表し、値が同じではない場合は true を返します。
ms.openlocfilehash: 8bfd8006eab0578c49d604b7583afe35beef17a7
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539417"
---
# <a name="isnotequalto"></a>IsNotEqualTo

**IsNotEqualTo** 要素は、プロパティと定数値または別のプロパティを比較する検索式を表し、値が同じではない場合は **true** を返します。 
...
|[Or](or.md) <br/> |含まれる検索式に対して論理 OR を実行する検索式を表します。 [または](or.md) 、子が **true** を返す場合は true を **返します**。 **または、2** つ以上の子が必要です。  <br/> |
   
## <a name="remarks"></a>注釈

文字列比較を実行するには、大文字と小文字や空白などの一致するパラメーターのオプションを提供する [Contains](contains.md) 要素の使用を検討してください。 結果を [ネゲート](not.md) するには、Not 要素と [Contains](contains.md) 要素を組み合わせて使用します。 
