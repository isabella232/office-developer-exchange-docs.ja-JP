...
**Openasadminorsystemservice**要素は、内部使用のみを対象としています。 この要素はクライアントによって使用されません。 
...
|**属性**|**説明**|
|:-----|:-----|
|LogonType  <br/> |クライアントの使用を想定したものではありません。  <br/> |
   
### <a name="child-elements"></a>子要素

|**Element**|**説明**|
|:-----|:-----|
|ConnectingSID  <br/> |クライアントの使用を想定したものではありません。  <br/> |
