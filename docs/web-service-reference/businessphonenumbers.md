...
description: BusinessPhoneNumbers 要素は、ビジネス電話番号の配列と、関連付けられたペルサのソース属性の識別子を指定します。
ms.openlocfilehash: 6de6bb2be8632c2872ff7ac771d559121c6454a0
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518884"
---
# <a name="businessphonenumbers"></a>BusinessPhoneNumbers

**BusinessPhoneNumbers** 要素は、ビジネス電話番号の配列と、関連付けられたペルサのソース属性の識別子を指定します。 
