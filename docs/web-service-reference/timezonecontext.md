...
、更新、作成されたオブジェクトの日付プロパティのタイム ゾーンを割り当てるときに既定値として使用されるタイム ゾーンの定義を指定するのには、Simple Object Access Protocol (SOAP) ヘッダーに**TimeZoneContext**要素を使用し、Exchange Web サービス (EWS) を使用して取得します。 
