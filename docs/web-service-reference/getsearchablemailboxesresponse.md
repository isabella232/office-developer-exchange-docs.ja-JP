...
description: GetSearchableMailboxesResponse 要素には、GetSearchableMailboxes 要求に対する応答が含まれる。
ms.openlocfilehash: d01680a1d684ae108051dac75b6738a1f9dd16f5
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539937"
---
# <a name="getsearchablemailboxesresponse"></a>GetSearchableMailboxesResponse

**GetSearchableMailboxesResponse** 要素には **、GetSearchableMailboxes** 要求に対する応答が含まれる。 
