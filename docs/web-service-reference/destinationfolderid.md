...
description: DestinationFolderId 要素は、コピーおよび移動アクションの移動先フォルダーを示します。
ms.openlocfilehash: abdb91dd8b9b005d0721f4dcf38766c280effe97
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542387"
---
# <a name="destinationfolderid"></a>DestinationFolderId

**DestinationFolderId 要素** は、コピーおよび移動アクションの移動先フォルダーを示します。 
...
|**Element**|**説明**|
|:-----|:-----|
|[FolderId](folderid.md) <br/> |移動先フォルダーの識別子と変更キーを格納します。  <br/> |
