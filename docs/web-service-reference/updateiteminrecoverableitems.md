...
**UpdateItemInRecoverableItems**要素は、回復可能な項目の項目を更新する要求を指定します。 
...
[ItemId](itemid.md) | [(項目) の更新プログラム](updates-item.md) | [添付ファイル](attachments-ex15websvcsotherref.md) | [MakeItemImmutable](makeitemimmutable.md)
