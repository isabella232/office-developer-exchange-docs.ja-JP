...
description: IntendedFreeBusyStatus 要素は、会議出席依頼に関連付けられている予定表アイテムの意図した状態を表します。
ms.openlocfilehash: fcadc2a155f2263410dbf81d200d202d718e2893
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539557"
---
# <a name="intendedfreebusystatus"></a>IntendedFreeBusyStatus

**IntendedFreeBusyStatus** 要素は、会議出席依頼に関連付けられている予定表アイテムの意図した状態を表します。 
