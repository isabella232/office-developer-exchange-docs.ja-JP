...
description: DeleteAttachmentResponseMessage 要素には、単一の DeleteAttachment 操作要求の状態と結果が含まれる。
ms.openlocfilehash: b795aa7855b770874293555156a19c7d2a18c46a
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59545448"
---
# <a name="deleteattachmentresponsemessage"></a>DeleteAttachmentResponseMessage

**DeleteAttachmentResponseMessage** 要素には、単一の [DeleteAttachment](deleteattachment-operation.md)操作要求の状態と結果が含まれる。 
...
|**属性**|**説明**|
|:-----|:-----|
|**ResponseClass** <br/> | [DeleteAttachment 操作応答の状態を説明](deleteattachment-operation.md)します。<br/><br/>この属性には、次の値が有効です。<br/><br/>- 成功  <br/>- 警告  <br/>- エラー  <br/> |
