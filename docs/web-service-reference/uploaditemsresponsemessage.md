...
description: UploadItemsResponseMessage 要素には、1 つのメールボックス アイテムをアップロードする要求の状態と結果が含まれる。
...
**UploadItemsResponseMessage** 要素には、1 つのメールボックス アイテムをアップロードする要求の状態と結果が含まれる。 
...
|[ItemId](itemid.md) <br/> |アップロードされたアイテムのアイテム識別子を含む。  <br/> |
