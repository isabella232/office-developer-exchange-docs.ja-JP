...
description: NumberOfMembersAvailable 要素は、推奨される会議時間に使用できる配布リスト メンバーの数を表します。 この要素は、状態が Free のメンバーを表します。
...
**NumberOfMembersAvailable 要素** は、推奨される会議時間に使用できる配布リスト メンバーの数を表します。 この要素は、状態が Free のメンバーを **表します**。
