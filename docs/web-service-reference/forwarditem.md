...
**ForwardItem**要素には、受信者に転送するのには、Exchange ストアの項目が含まれています。 
...
代理人によってアイテムが転送された場合、プリンシパルの電子メール アドレス[から](from.md)要素を設定してください。 代理人が、 [From](from.md)プロパティを設定していない場合、代理人のメールボックスから直接送信されたアイテムが表示されます。 
