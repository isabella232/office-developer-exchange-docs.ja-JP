...
**AddNewImContactToGroup**要素は、インスタントメッセージンググループに新しいインスタントメッセージングの連絡先を追加する要求を定義します。 
...
[Imaddress (非 Emptystringtype)](imaddress-nonemptystringtype.md)  | [DisplayName (非 Emptystringtype)](displayname-nonemptystringtype.md)  | [GroupId](groupid.md)
