...
---
# <a name="mailtipsaccesslevel-soap"></a>Mailヒント Accesslevel (SOAP)

**Mailヒント accesslevel**要素は、 **mailヒント accesslevel**プロパティを表します。 **Mailヒント Accesslevel**要素は、内部使用のみを対象としています。 この要素はクライアントによって使用されません。 
...
この要素は、応答で返されるメールヒントの詳細の最大量を指定します。
