...
description: GetSharingFolderResponseMessage 要素には、1 つの GetSharingFolder 操作要求の状態と結果が含まれる。
ms.openlocfilehash: 6eb95ea779b003021cd51a4fa31a8d30440da21b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515832"
---
# <a name="getsharingfolderresponsemessage"></a>GetSharingFolderResponseMessage

**GetSharingFolderResponseMessage** 要素には [、1 つの GetSharingFolder](getsharingfolder-operation.md)操作要求の状態と結果が含まれる。 
