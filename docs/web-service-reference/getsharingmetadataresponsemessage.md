...
description: GetSharingMetadataResponseMessage 要素には、1 つの GetSharingMetadata 操作要求の状態と結果が含まれる。
...
**GetSharingMetadataResponseMessage** 要素には [、1 つの GetSharingMetadata](getsharingmetadata-operation.md)操作要求の状態と結果が含まれる。 
...
|[EncryptedSharedFolderDataCollection](encryptedsharedfolderdatacollection.md) <br/> |クライアントが予定表の共有または他のクライアントとの連絡先データの共有を承認するために使用できるデータ構造のコレクションが含まれています。  <br/> |
