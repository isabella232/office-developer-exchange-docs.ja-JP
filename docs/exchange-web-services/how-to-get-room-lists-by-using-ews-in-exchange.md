...
- [<span data-ttu-id="b33e7-150">作成し、ルームのメールボックスの管理</span><span class="sxs-lookup"><span data-stu-id="b33e7-150">Create and Manage Room Mailboxes</span></span>](http://technet.microsoft.com/ja-jp/library/jj215781%28v=exchg.150%29.aspx)
