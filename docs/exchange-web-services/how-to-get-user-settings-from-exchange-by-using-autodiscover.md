...
- [<span data-ttu-id="80f26-157">Exchange Web サービス (EWS) の管理の API</span><span class="sxs-lookup"><span data-stu-id="80f26-157">Exchange Web Services (EWS) Managed API</span></span>](http://msdn.microsoft.com/en-us/library/exchange/jj220535%28v=exchg.80%29.aspx)
